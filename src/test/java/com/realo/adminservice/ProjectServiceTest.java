...
class ProjectServiceTest {
    ...
    void testGetProjectByIdSuccess() {
        ...
        StepVerifier.create(projectService.getByIdWithUsers(projectId))
                .expectNext(project)
                .verifyComplete();
    }
    ...
    void testDeleteProjectFailure() {
        ...
        when(projectUserRepository.deleteByProjectId(projectId)).thenReturn(Flux.just());
    ...
    void testAddUserToProjectSuccess() {
        ...
        when(projectRepository.findById(projectId)).thenReturn(Mono.just(project));
        when(projectService.getByIdWithUsers(projectId)).thenReturn(Mono.just(project));
